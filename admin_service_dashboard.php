...
<div class="container">
<div class="innerdiv">
<div class="row"><div class='container'><img class="imglogo"  width="100%" height=" 100%" src="https://lai.gwu.edu/sites/g/files/zaxdzs1366/f/image/Icons/libraries-02.png"/></div></div>
            <div class="leftinnerdiv mb-5">
            ...
            padding: 8px;'>Person Name</th><th>Book name</th><th>Days </th><th>Approve</th></tr>";
            foreach($recordset as $row){
              ...
              "<td>$row[2]</td>";
               ...
               // $table.="<td><a href='approvebookrequest.php?reqid=$row[0]&book=$row[5]&userselect=$row[3]&days=$row[6]'><button type='button' class='btn btn-primary'>Approved BOOK</button></a></td>";
                 $table.="<td><a href='approvebookrequest.php?reqid=$row[0]&book=$row[4]&userselect=$row[3]&days=$row[5]'><button type='button' class='btn btn-primary'>Approved</button></a></td>";
            ...
            <div class="rightinnerdiv container">   
            ...
            <form action="addbookserver_page.php" method="post" enctype="multipart/form-data" class="form-control">
            <label>Book Name:</label><input type="text" name="bookname" class="form-control"/>
            <label>Detail:</label><input  type="text" name="bookdetail" class="form-control"/>
            <label>Autor:</label><input type="text" name="bookaudor" class="form-control"/>
            <label>Publication</label><input type="text" name="bookpub" class="form-control"/>
            <div><label>Branch:</label><input type="radio" name="branch" value="other"/>Other
            <input type="radio" name="branch" value="BSIT"/>BSIT
            <div style="margin-left:80px">
            <input type="radio" name="branch" value="BSCS"/>BSCS
            <input type="radio" name="branch" value="BSSE"/>BSSE</div>
            </div>   
            <label>Price:</label><input  type="number" name="bookprice" class="form-control"/>
            <label>Quantity:</label><input type="number" name="bookquantity" class="form-control"/>
            <label>Book Photo</label><input  type="file" name="bookphoto" class="form-control"/><br>
            <input type="submit" value="SUBMIT"/>
            </form>
            </div>
            </div>
...
?>
            ...
            $table="<table style='font-family: Arial, Helvetica, sans-serif;border-collapse: collapse;width: 100%;'><tr><th style=' 
            padding: 8px;'> Name</th><th>Email</th><th>Delete</th></tr>";
            foreach($recordset as $row){
                $table.="<tr>";
            //    "<td>$row[0]</td>";
                $table.="<td>$row[1]</td>";
...
<br>
           <label>Days</label> <input type="number" name="days"/>
            ...
            $table="<table style='font-family: Arial, Helvetica, sans-serif;border-collapse: collapse;width: 100%;'><tr><th style='  
            padding: 8px;'>Issue Name</th><th>Book Name</th><th>Days</th><th>Issue Date</th><th>Return Date</th><th>Fine</th></th></tr>";
